...
//import io.github.iwyfewwnt.steamid.exceptions.*;
...
import io.github.iwyfewwnt.steamid.utils.USteamPattern;
import io.github.iwyfewwnt.steamid.utils.USteamRegex;
...
//	}
	...
	public static boolean isSteamXuidValid(String xuid) {
		...
		try {
			return isSteamXuidValid(Long.parseUnsignedLong(xuid));
	...
	public static boolean isSteamId2Valid(String id2) {
		...
		try {
			return isSteamId2Valid(
					Long.parseUnsignedLong(
							m.group(USteamRegex.Group.ID)
					)
			);
		} catch (NumberFormatException e) {
			e.printStackTrace();
